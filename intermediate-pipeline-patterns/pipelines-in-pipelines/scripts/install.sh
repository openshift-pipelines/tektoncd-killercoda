#!/bin/bash
# Background script: installs Tekton Pipelines with beta API fields and tkn CLI
...
# Enable beta API fields (required for Pipelines in Pipelines)
...
echo "Tekton Pipelines (beta API fields enabled) and tkn CLI are ready!"
