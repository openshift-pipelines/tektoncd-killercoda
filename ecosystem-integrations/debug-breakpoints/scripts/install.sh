#!/bin/bash
# Background script: installs Tekton Pipelines with alpha API fields and tkn CLI
...
# Enable alpha API fields (required for breakpoint debugging)
...
echo "Tekton Pipelines (alpha API fields enabled) and tkn CLI are ready!"
