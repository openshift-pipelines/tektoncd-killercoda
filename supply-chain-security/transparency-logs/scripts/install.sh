#!/bin/bash
# Background script: installs Tekton Pipelines, Chains, tkn CLI, cosign, and rekor-cli
...
# Install rekor-cli
REKOR_VERSION="1.3.6"
curl -LO "https://github.com/sigstore/rekor/releases/download/v${REKOR_VERSION}/rekor-cli-linux-amd64"
chmod +x rekor-cli-linux-amd64 && mv rekor-cli-linux-amd64 /usr/local/bin/rekor-cli

echo "Tekton Pipelines, Chains, tkn, cosign, and rekor-cli are ready!"
