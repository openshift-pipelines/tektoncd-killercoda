#!/bin/bash
# Background script: installs Tekton Pipelines, Chains, Vault (dev mode), and tkn CLI
...
# ── 2. Install Tekton Chains v0.26.0 ────────────────────────────────────────
...
# ── 3. Install Vault in dev mode via Helm ────────────────────────────────────
...
echo "Tekton Pipelines, Chains, Vault (dev mode), tkn, and cosign are ready!"
