...
# Tekton Dashboard with external-logs, and tkn CLI v0.43.0
...
# ── 6. Install Tekton Dashboard (read-write mode) ───────────────────────────
...
echo "Tekton Pipelines, Results, Dashboard, and tkn CLI are ready!"
